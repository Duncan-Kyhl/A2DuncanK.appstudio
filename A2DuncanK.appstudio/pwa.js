...
const cacheName = 'A2DuncanK-2021-02-28 22:06:55.968173'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A2DuncanK'.length) === 'A2DuncanK') {
